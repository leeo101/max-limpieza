...
export default function PromoBanner() {
  ...
  const banners = [
    { text: "🚚 ¡ENVÍO GRATIS en compras superiores a $400.000!", icon: <Truck size={14} />, color: "bg-sky-600" },
    { text: "💵 10% OFF pagando en EFECTIVO PRESENCIAL", icon: <Sparkles size={14} />, color: "bg-emerald-600" },
