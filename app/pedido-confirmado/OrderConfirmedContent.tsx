        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            {order && (
              <div className="bg-gray-50 rounded-lg p-6 mb-6 text-left">
                ...
                <div className="flex justify-between mb-2">
                  ...
                  <span className="font-bold text-sky-600">${order.total.toLocaleString('es-AR')}</span>
                </div>
            ...
            <div className="space-y-4 mb-8">
              ...
              <ul className="text-left text-gray-600 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>Nos pondremos en contacto contigo para confirmar el pedido</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald-600 font-bold">2.</span>
                  <span>Coordinaremos la entrega y forma de pago</span>
                </li>
                <li className="flex items-start gap-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href={`https://wa.me/${whatsappNumber}?text=Hola!%20Quiero%20consultar%20sobre%20mi%20pedido%20${order ? '#' + order.id.slice(-6) : ''}`}
                target="_blank"
